...
public class FaizPointer extends CustomOrb {
	public static final String ORB_ID = "FaizPointer";
	private static final OrbStrings orbString;
	public static final String[] DESC;
	
	public FaizPointer() {
		super(ORB_ID, orbString.NAME, 1, 1, DESC[0], DESC[1], "img/orbs/SB-555L.png");
	...
	public void onStartOfTurn() {
		if(EnterButtonAction.FaizPointer) {
	...
	public void render(SpriteBatch sb) {
		if(!EnterButtonAction.FaizPointer && this.name != "SB-555P(off)") {
			this.name = "SB-555P(off)";
			this.img = ImageMaster.loadImage("img/orbs/SB-555L_N.png");
		}
		if(EnterButtonAction.FaizPointer && this.name != "SB-555P(on)") {
	...
	public CustomOrb makeCopy() {
		return new FaizPointer();
	}

	static {
		orbString = CardCrawlGame.languagePack.getOrbString("FaizPointer");
