...
public class FaizShot extends CustomOrb {
	...
	public FaizShot() {
		super(ORB_ID, orbString.NAME, 1, 1, DESC[0], DESC[1], "img/orbs/SB-555C.png");
	...
	public void render(SpriteBatch sb) {
		if(!EnterButtonAction.FaizShot && this.name != "SB-555C(off)") {
			this.name = "SB-555C(off)";
			this.img = ImageMaster.loadImage("img/orbs/SB-555C_N.png");
		}
		if(EnterButtonAction.FaizShot && this.name != "SB-555C(on)") {
