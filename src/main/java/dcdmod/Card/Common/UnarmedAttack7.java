...
public class UnarmedAttack7 extends AbstractCustomCardWithType{
	...
	public static final String ID = "UnarmedAttack7";
	private static final CardStrings cardStrings;
	public static final String NAME;
	public static final	String DESCRIPTION;
	public static final String UPGRADE_DESCRIPTION;
	public static final String IMG_PATH = "img/cards/UnarmedAttack7.png";
	private static final int COST = 1;
	private static final int ATTACK_DMG = 9;
	
	
	public UnarmedAttack7() {
    ...
    static {
    	cardStrings = CardCrawlGame.languagePack.getCardStrings("UnarmedAttack7");
        NAME = UnarmedAttack7.cardStrings.NAME;
        DESCRIPTION = UnarmedAttack7.cardStrings.DESCRIPTION;
        UPGRADE_DESCRIPTION = UnarmedAttack7.cardStrings.UPGRADE_DESCRIPTION;
    }
