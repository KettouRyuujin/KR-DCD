...
public class FlameSpecialCard extends AbstractCustomCardWithType{
    ...
    static {
        ...
        NAME = FlameSpecialCard.cardStrings.NAME;
        DESCRIPTION = FlameSpecialCard.cardStrings.DESCRIPTION;
        EXTENDED_DESCRIPTION = FlameSpecialCard.cardStrings.EXTENDED_DESCRIPTION;
    }
