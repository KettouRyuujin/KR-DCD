...
public class FaizAnimationAction {
    ...
    public static String AXEL_FAR_JSON2 = "img/char/DCD_Animation/faiz_Axel/Axel_CrimsonSmash_2A.json";
    public static String AXEL_FAR_JSON3 = "img/char/DCD_Animation/faiz_Axel/Axel_CrimsonSmash_3A.json";
    public static String AXEL_FAR_JSON4 = "img/char/DCD_Animation/faiz_Axel/Axel_PunchingUnit.json";
    public static AnimationLoader FAR_faiz = new AnimationLoader("img/char/DCD_Animation/FAR/FAR.atlas", "img/char/DCD_Animation/FAR/FAR_FAR_faiz.json",  1.0f);
