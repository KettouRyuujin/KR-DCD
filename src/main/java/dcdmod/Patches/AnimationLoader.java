    ...
    private static class LoadAnimationTask implements Runnable {
        ...
        public void run() {
            synchronized (AbstractDungeon.player) {
                loadAnimation(creature, new AnimationLoader(loader.atlas, skeletonUrl, scale));
                if (trackIndex != null && animationName != null && loop != null) {
                    creature.state.setAnimation(trackIndex, animationName, loop);
                }
            }
