...
public class SpecialDragreder
{
    ...
    public static String DRAGREDER_ATLAS = "img/char/DCD_Animation/dragreder/dragreder.atlas";
    public static String DRAGREDER_JSON1 = "img/char/DCD_Animation/dragreder/dragreder_appear.json";
    public static String DRAGREDER_JSON2 = "img/char/DCD_Animation/dragreder/dragreder_attack.json";
    public static String DRAGREDER_JSON3 = "img/char/DCD_Animation/dragreder/dragreder_defendtonormal.json";
    public static String DRAGREDER_JSON4 = "img/char/DCD_Animation/dragreder/dragreder_disappear.json";
    public static String DRAGREDER_JSON5 = "img/char/DCD_Animation/dragreder/dragreder_normal.json";
    public static String DRAGREDER_JSON6 = "img/char/DCD_Animation/dragreder/dragreder_normaltodefend.json";
